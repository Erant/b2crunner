...
helical.yaml` calls `wan22_vace_denoise` twice with six other
...
def load_signature(step_class, params):
    ...
    two reasons:
      ...
      * The alternative default — reload whenever any param differs —
        ...
        helical.yaml, i.e. it would do nothing at all for the
...
def release_vram(logger, step) -> None:
    ...
    reason `keep_loaded` is safe to turn on. helical.yaml puts
