...
def _registry() -> List[ModelSource]:
    ...
    return [
        ...
        ModelSource(
            ...
            # a step builds the model. Only sam3d_body does now:
            # fit_head_to_face used to call `load_sam_3d_body` too, and
            # since 2026-09-07 builds the MHR head alone, backbone-free.
