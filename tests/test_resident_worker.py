...
The measurement this exists for: `pipeline/workflows/helical.yaml`
...
class TestResidency(unittest.TestCase):
    ...
    def test_run_params_that_do_not_affect_load_do_not_reload(self):
        """helical's actual difference between the passes.
...
class TestVramEviction(unittest.TestCase):
    ...
    `brush` — a GPU program — runs between helical's two denoise
...
class TestWiring(unittest.TestCase):
    ...
    def test_the_runner_keys_its_dispatcher_cache_on_keep_loaded(self):
        ...
        resident worker (helical's two denoise passes). A third
    ...
    def test_a_per_call_param_does_not_move_the_signature(self):
        """helical's two passes differ only by `strength`, and a
